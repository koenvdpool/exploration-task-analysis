...
file_info = [
    ...
    ('../../csv_data/archive_data/sem_3bots_3hum.csv', 'Human: Semantic 3B3H', 0),
    ('../../csv_data/archive_data/sem_3bots_3hum.csv', 'Bot: Semantic 3B3H', 1),
    ('../../csv_data/archive_data/sem_3bots_3hum.csv', 'All: Semantic 3B3H', None),
