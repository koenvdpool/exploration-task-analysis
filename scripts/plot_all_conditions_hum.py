...
path_nonsem_6hum = '../../data/performance/nonsem_6hum.csv'
path_nonsem_1bot_5hum = '../../data/performance/nonsem_1bot_5hum.csv'
path_nonsem_3bots_3hum = '../../data/performance/nonsem_3bots_3hum.csv'
...
boxplot_items_all_hum.savefig('../../plots/performance/condition-all/boxplot_items_all_hum.pdf', format='pdf')
...
boxplot_score_all_hum.savefig('../../plots/performance/condition-all/boxplot_score_all_hum.pdf', format='pdf')
