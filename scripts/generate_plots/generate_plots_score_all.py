...
sem_1bot_5hum_score = get_col_as_ints('../../csv_data/sem_1bot_5hum.csv', SCORE_COLUMN_INDEX)
...
nonsem_1bot_5hum_score = get_col_as_ints('../../csv_data/nonsem_1bot_5hum.csv', SCORE_COLUMN_INDEX)

# Condition: non-semantic and hybrid (bots = 3, humans = 3)
nonsem_3bots_3hum_score = get_col_as_ints('../../csv_data/nonsem_3bots_3hum.csv', SCORE_COLUMN_INDEX)
...
boxplot_score.savefig('../../plots/condition-all/boxplot_score_sem_vs_nonsem.pdf', format='pdf')
boxplot_score.show()
