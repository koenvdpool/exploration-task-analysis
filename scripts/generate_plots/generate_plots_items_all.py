...
sem_1bot_5hum_items = get_col_as_ints('../csv_data/sem_1bot_5hum.csv', ITEM_COLUMN_INDEX)
...
nonsem_1bot_5hum_items = get_col_as_ints('../csv_data/nonsem_1bot_5hum.csv', ITEM_COLUMN_INDEX)

# Condition: non-semantic and hybrid (bots = 3, humans = 3)
nonsem_3bots_3hum_items = get_col_as_ints('../csv_data/nonsem_3bots_3hum.csv', ITEM_COLUMN_INDEX)
...
boxplot_items.savefig('../plots/condition-all/boxplot_items_sem_vs_nonsem.pdf', format='pdf')
boxplot_items.show()
