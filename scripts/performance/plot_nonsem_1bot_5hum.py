...
path_nonsem_1b5h = '../../data/performance/nonsem_1bot_5hum.csv'
...
boxplot_items_nonsem_1b5h.savefig('../../plots/performance/condition-non-semantic/boxplot_items_nonsem_1bot_5hum.pdf', format='pdf')
...
boxplot_score_nonsem_1b5h = create_boxplot(score_data_nonsem_1b5h, 'Score',
                                           ...
                                           nonsem_1b5h_figsize, bbox_to_anchor=(0.75, 1), outliers=True)
boxplot_score_nonsem_1b5h.savefig('../../plots/performance/condition-non-semantic/boxplot_score_nonsem_1bot_5hum.pdf', format='pdf')
