...
items_nonsem_1bot_5hum = get_col_as_ints('../../data/performance/nonsem_1bot_5hum.csv', ITEM_COLUMN_INDEX)
items_nonsem_3bots_3hum = get_col_as_ints('../../data/performance/nonsem_3bots_3hum.csv', ITEM_COLUMN_INDEX)

score_nonsem_6hum = get_col_as_ints('../../data/performance/nonsem_6hum.csv', SCORE_COLUMN_INDEX)
score_nonsem_6bots = get_col_as_ints('../../data/performance/6bots.csv', SCORE_COLUMN_INDEX)
score_nonsem_1bot_5hum = get_col_as_ints('../../data/performance/nonsem_1bot_5hum.csv', SCORE_COLUMN_INDEX)
score_nonsem_3bots_3hum = get_col_as_ints('../../data/performance/nonsem_3bots_3hum.csv', SCORE_COLUMN_INDEX)
...
boxplot_items.savefig('../../plots/performance/condition-all/boxplot_items_all.pdf', format='pdf')
boxplot_items.show()
...
boxplot_score.savefig('../../plots/performance/condition-all/boxplot_score_all.pdf', format='pdf')
boxplot_score.show()
