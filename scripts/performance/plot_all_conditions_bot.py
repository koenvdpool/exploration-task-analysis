...
path_nonsem_6bots = '../../data/performance/6bots.csv'
...
boxplot_items_all_bot.savefig('../../plots/performance/condition-all/boxplot_items_all_bots.pdf', format='pdf')
...
boxplot_score_all_bot.savefig('../../plots/performance/condition-all/boxplot_score_all_bots.pdf', format='pdf')
